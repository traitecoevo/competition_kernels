...
% GEORGES: I find the point iii) too short because it is unclear how this approach have something to say about coexistence.
...
% GEORGES: I think we could also have a section showing these resources explicit models need to move toward traits that are measurable in the field as this will make their prediction comparable with field data. In addition, the approach Kunstler-Lasky-Kraft may allow to test separately sub-model of these models.
There is also
...
\citep[e.g.][]{Kunstler-2012, Lasky-2015, Kraft-2015}.  The findings of such
