...
\affiliation{Department of Biological Sciences, Macquarie University,
  Sydney, Australia}
\runninghead{Competition functions in resource-based models}
...
Competition for resources is a powerful force structuring ecological communities \citep{Schluter-2000,Vellend-2016}.
Competition not only regulates the overall abundance of individuals that can be supported by a resource, it also though to regulate the diversity of species that can be supported, by excluding some while allowing others to survive \citep[e.g.][]{Gause-1934,,Lack-1947,MacArthur-1967}. 
Competition for resources can also drive evolutionary arms races by selecting for adaptations that give prior access to a resource, in the process altering the dynamics of populations and biogeochemical cycles.
% High diversity may also be possible for communities in which species evolve to be ecologically and therefore competitively equivalent, via the combined processes of drift and speciation.
Understanding the strength and nature of competitive interactions among individuals is therefore a foundation for theories of community assembly and adaptive evolution.

Functional traits --- heritable characters affecting some aspect of organism function --- are widely thought to influence competitive interactions. The idea of species arranged along a resource axes, differentiated in their resource use via some trait (e.g., Figure
\ref{fig:competition-functions}) is iconic within community ecology and
...
Krebs-2013}. 
More concretely, in plants, specific traits have been shown to influence competitive interactions, including traits such as ...... \citep{Kunstler-2016}. However, 
Thus to understand how competition for resources influences communities, we must ultimately understand its relation to traits. 

Much theory about ecological communities has been developed using at least two different approaches for modelling competitive interactions via traits. 
The first approach applies variants of Lotka-Volterra's phenomenological model of population dynamics, wherein competitive interactions are calculated directly from the densities of competitors and pairwise ``competition coefficients'' \citep{Lotka-1925, Volterra-1926}. Variants of the Lotka-Volterra model form the foundation for much theory in community ecology, including: the competitive exclusion principle \citep{Gause-1934}, limiting similarity \citep{MacArthur-1967, May-1972, Slatkin-1980}, character displacement \citep{Taper-1985, Case-2000}, species coexistence and community assembly \citep{MacArthur-1967, Calcagno-2006, Leimar-2013}, Chesson's modern coexistence theory \citep{Chesson-2000,Barabas-2018}, the competition colonisation trade-off (??), and sympatric speciation \citep{Dieckmann-1999}. 
...
% Here we us k for the resources subscript and in the appendix we use j. I change everything to k in the appendix (but this could be the other way around if you think that there are risk of confusion between k and K.

% TODO[RGF]: See Rstar results for another discussion here, but we
% need to tidy up what x is.
...
% GK: the branch alternat_rstar have a model with C=U
...
\begin{figure}[h]
  ...
  \label{fig:Rstar}
\end{figure}
% I changed c to C to match the text. BASED ON R CODE THIS 2,2 and not 0.5,0.5 for the symmetric case and this match the text BUR RICH YOU NEED TO CHECK
