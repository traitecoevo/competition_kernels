...
functions were: i) density dependent, implying non-linear per-capita
...
surprising, as it might be hoped that the more complex resource-based  models
...
\textit{Linking to field measurement of competition.}
\begin{itemize}
