...
% TODO: Run out the evolutionary dynamics of tree/hmat and Kisdi to
...
Gaussian \citet{Roughgarden-1979} and Logistic  \citep{e.g.
Kisdi-1999,Law-1997}. The derived function from the HMAT model looks a lot
like the logistic kernels used in models investigating asymmetric competition
\citep{e.g. Kisdi-1999, Law-1997}.  An asymmetric kernel is also implicit in
